...
import { FamilyOfficeDocuments } from "@/components/family-office-documents"
      ...
      <div className="mx-auto flex flex-col gap-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-0.5">
            Aggregated documents across all member portfolios. Read-only view.
          </p>
        </div>
        <FamilyOfficeDocuments
