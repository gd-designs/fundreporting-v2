...
import { FamilyOfficeMutations } from "@/components/family-office-mutations"
      ...
      <div className="mx-auto flex flex-col gap-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-0.5">
            Aggregated mutations across all member portfolios. Read-only view.
          </p>
        </div>
        <FamilyOfficeMutations
