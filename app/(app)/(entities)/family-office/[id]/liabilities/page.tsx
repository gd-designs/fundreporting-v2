...
import { FamilyOfficeLiabilities } from "@/components/family-office-liabilities"
...
export default async function FamilyOfficeLiabilitiesPage({ params }: { params: Promise<{ id: string }> }) {
      ...
      <div className="mx-auto flex flex-col gap-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-0.5">
            Aggregated liabilities across all member portfolios. Read-only view.
          </p>
        </div>
        <FamilyOfficeLiabilities
